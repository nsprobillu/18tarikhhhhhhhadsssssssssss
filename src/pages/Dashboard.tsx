...
export function Dashboard() {
  ...
  // Save pagination and search preferences to localStorage
  useEffect(() => {
          ...
          response.data.data.map(async (email: TempEmail) => {
            try {
              ...
              const lastEmail = lastEmailResponse.data.data && lastEmailResponse.data.data.length > 0 
                ...
                : (lastEmailResponse.data && lastEmailResponse.data.length > 0 
                  ? lastEmailResponse.data[0] 
                  : null);
  ...
  const filteredEmails = tempEmails;
        ...
        {captchaRequired && captchaSiteKey && (
          <div className="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div className="flex items-center text-blue-700 mb-3">
              ...
              <p>Please complete the CAPTCHA verification and click on create to create unlimited emails. if you don't see captcha then click on CREATE OR 🔄</p>
            </div>
            <CaptchaVerification 
